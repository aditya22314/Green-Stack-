...
const LoginForm = () => {
  ...
  const { setShowUserLogin, navigate, setUser, axios } = useAppContext();
  ...
  return (
    <div
      ...
      className="fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm text-gray-600 bg-black/70"
    >
      <form
